  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0"><a href="<?php echo base_url();?>acceuil.html" class="text-black h2 mb-0">Travelers</a></h1>
          </div>
          <div class="col-10 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                <li class="active">
                 <a href="<?php echo base_url();?>acceuil.html">Home</a>
                </li>
                <li>
                  <a href="<?php echo base_url();?>destination.html">Destinations</a>
                  
                </li>
                
                <li><a href="<?php echo base_url();?>service.html">Services</a></li>
                <li><a href="<?php echo base_url();?>team.html">About</a></li>
                <li><a href="<?php echo base_url();?>blog.html">Blog</a></li>
                <li><a href="<?php echo base_url();?>login.html">Log as Admin</a></li>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2 class="font-weight-light text-black">Some of our Destinations</h2>
		...
		<?php foreach($Destination as $destination){?>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
		   <form  method="post" action="<?php echo base_url();?>singleDestination-<?php echo $destination['id'];?>.html" >
            <a  class="unit-1 text-center">
              <img src="<?php echo base_url();?>assets/images/<?php echo $destination['image'];?>" alt="Image" class="img-fluid">
              <div class="unit-1-text">
                <strong class="text-primary mb-2 d-block">$<?php echo $destination['prix'];?></strong>
                <h3 class="unit-1-heading"><?php echo $destination['nom'];?></h3>
				 <input type="hidden" name="idDest" value="<?php echo $destination['id'];?>"/>
              </div>
            </a>
			  <div class="col-12 text-center">
            <button type="submit" class="btn btn-outline-primary border-2 py-3 px-5">Read More ...</button>
          </div>
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2 class="font-weight-light text-black">Some of our Services</h2>
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="unit-4 d-flex">
              <div class="unit-4-icon mr-4"><span class="<?php echo $service['icon'];?>"></span></div>
              <div>
      ...
      <div class="container">
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-6 col-lg-6">
                <ul class="list-unstyled">
                  <li> <a href="<?php echo base_url();?>acceuil.html">Home</a></li>
                  <li> <a href="<?php echo base_url();?>destination.html">Destination</a></li>
                  <li> <a href="<?php echo base_url();?>service.html">Services</a></li>
                  <li> <a href="<?php echo base_url();?>team.html">About</a></li>
                </ul>
              </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> RAKOTOHANITRINIAINA Maharo RivoMahefa ETU000618<i class="icon-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >Colorlib</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
