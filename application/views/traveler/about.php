        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h1 class="text-white font-weight-light">About</h1>
      ...
      <div class="container">
		...
		<?php foreach($Team as $team){?>
          ...
          <div class="col-md-6 col-lg-4 text-center mb-5" data-aos="fade-up">
            <img src="<?php echo base_url();?>assets/images/<?php echo $team['image'];?>" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
            <h2 class="text-black font-weight-light mb-4"><?php echo $team['nom'];?></h2>
            <p class="mb-4"><?php echo $team['description'];?></p>
            <p>
